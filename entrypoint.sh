...
jhsingle-native-proxy --destport $destport --authtype none voila /home/jovyan/Presentation.ipynb {--}template=material {--}port={port} {--}no-browser {--}Voila.base_url={base_url}/ {--}Voila.server_url=/ --port $port
